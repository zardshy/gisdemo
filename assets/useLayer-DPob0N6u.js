async function d(s){try{const i="vec3(0.0, 0.5, 3)",t=await Cesium.Cesium3DTileset.fromUrl("/models/3dtiles/sh150/tileset.json",{customShader:new Cesium.CustomShader({lightingModel:Cesium.LightingModel.UNLIT,fragmentShaderText:`
